        ...
        <div className="card p-3 mt-2">
            <div className=" row ">
                <div className="user col-1">
                    <img src={props.review.userImg} width="30" alt="user" className="user-img rounded-circle"></img>
                    <small className="font-weight-bold text-primary d-flex align-items-center ml-1">{props.review.username}</small>
                </div>
